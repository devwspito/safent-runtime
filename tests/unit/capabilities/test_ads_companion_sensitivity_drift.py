...
@pytest.mark.parametrize("tool", ["propose_campaign_draft", "propose_campaign_from_draft", "propose_meta_image_upload"])
...
@pytest.mark.parametrize("tool", ["list_campaign_drafts", "get_campaign_draft", "get_meta_image_upload"])
