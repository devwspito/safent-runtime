"""AutonomousRunnerPort fake en memoria — testing-only.
...
class InMemoryAutonomousRunner:
    ...
    def __getattr__(self, name: str) -> Any:  # pragma: no cover
        raise NotImplementedError(
            f"InMemoryAutonomousRunner.{name}() todavía no implementado — pendiente de tareas US1+."
        )
